/*
  ...
  - You are about to drop the column `partipantId` on the `Guess` table. All the data in the column will be lost.
...
INSERT INTO "new_Guess" ("createdAt", "firstTeamGoals", "gameId", "id", "secondTeamGoals") SELECT "createdAt", "firstTeamGoals", "gameId", "id", "secondTeamGoals" FROM "Guess";
DROP TABLE "Guess";
